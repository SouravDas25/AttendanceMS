        ...
        <form class="form-horizontal" action='/{{Request::path()}}/submit' 
					...
					<div class="col-md-8 col-md-offset-4">
						<small>
							<div class="row">
								...
								<div class="col-md-4">
									<select id="name_col" name="name_col" class="form-control" required disabled>
		    					</select>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-4">
									<select id="roll_col" name="roll_col" class="form-control" required disabled>
		    					</select>
								</div>
				...
				<div class="form-group">
					<label class="col-md-4 control-label"></label>
				  	<span class="col-md-4"><a href="/csv/sample_batch.csv">See Sample File</a></span>
				</div>
