...
<div id="wrapper">
	<nav class="navbar navbar-default top-navbar" role="navigation">
		...
		@include('widgets.login_dropdown',['login_email_link' => '/','ld_class'=>'hidden-xs'])
	</nav>
	<!--/. NAV TOP  -->
		...
		<div class="sidebar-collapse ">
			<ul class="nav" id="main-menu">
				...
				<li {!! (Request::is('*home/myclass*') ? 'class="active-menu"' : '') !!} >
					<a href="{{ url('home/myclass') }}" class="waves-effect waves-dark" title="View Classes Taken By You" >
						<i class="fa fa-lastfm"></i>My Classes </a>
				</li>
				<li {!! (Request::is('*home/class*') ? 'class="active-menu"' : '') !!}>
					<a href="{{ url('home/class') }}" class="waves-effect waves-dark" title="Take A Class's Attendance">
				...
				<li>
					...
					<ul class="nav nav-second-level collapse in" aria-expanded="true">
						<li {!! (Request::is('*home/batch*') ? 'class="active-menu"' : '') !!} >
							<a href="{{ url('home/batch') }}" class="waves-effect waves-dark" title="View Attendance Of Current Semester.">
								<i class="fa fa-bar-chart-o"></i>Current Semester</a>
						</li>
						<li  {!! (Request::is('*home/long.term*') ? 'class="active-menu"' : '') !!} >
							<a href="{{ url('home/long.term') }}" class="waves-effect waves-dark" title="View Attendance Of Previous Semester.">
