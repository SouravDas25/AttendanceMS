...
<footer class="page-footer teal">
	...
	<div class="footer-copyright">
		<div class="container">
			Made by
			<a class="brown-text text-lighten-3" href="#">Sourav Das & Ejaz Ahmed</a>
		</div>
	</div>
</footer>
...
<div id="modal1" class="modal">
	<div class="modal-content">
		<h4>Sign In</h4>
		<p>
			<form role="form" action="/login.verify" method="post" id="login-form">
	...
	<div class="modal-footer">
		...
		<button class="btn btn-danger waves-effect waves-green btn-flat" onclick="login_submit()" /> Sign In
		</button>
	</div>
</div>
@endsection
