...
@section('page_heading','Update Attendance' )
@section('section')	
<div class ="row">
	<div class ="col-sm-8">
		@section ('pane2_panel_title', $student->student_name)
    @section ('pane2_panel_body')
      <form class="form-horizontal" action='/home/long.term/update/submit' method="post">
				<fieldset>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  	<input name="attn" type="number" class="form-control input-md" required="" value="{{ $data->attendance }}">
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  	<input name="total" type="number" class="form-control input-md" required="" value="{{ $data->total }}">
				  </div>
				</div>
				...
				<div class="form-group">
				  	...
				  	<select name="sem_no" class="form-control" required="" >
				  		@foreach($sems as $sem) 
					      	<option value="{{{ $sem }}}" {{ ($data->sem_no == $sem) ? "selected" : "" }}>
