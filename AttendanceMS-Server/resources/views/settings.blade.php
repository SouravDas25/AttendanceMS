        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <form class="form-horizontal"method="POST" action="settings/password/submit">
                    ...
                    <div class="col-md-5">
                        <input id="current_pwd" name="current_pwd" type="password" placeholder="" class="form-control input-md" required="">
                    ...
                    <div class="col-md-5">
                        <input id="new_pwd" name="new_pwd" type="password" placeholder="" class="form-control input-md" required="">
                    </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <input id="cnfrm_pwd" name="cnfrm_pwd" type="password" placeholder="" class="form-control input-md" required="">
                    </div>
                    </div>
