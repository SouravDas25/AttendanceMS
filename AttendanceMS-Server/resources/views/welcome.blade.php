	...
	<div class="section no-pad-bot">
		<div class="container">
			<div class="row center">
				<img src="{{ asset("/img/Tict_logo.png") }}" alt="img-responsive" class="img-responsive header center animated bounceInDown">
			</div>
			<h1 class="header center teal-text text-lighten-4 res-font animated bounceInRight">Techno India College Of Technology</h1>
			<div class="row center">
			...
			<div class="row center animated bounceInUp">
				...
				<a href="/home" class="btn-large waves-effect waves-light teal lighten-1">
					Dashboard
				</a>
				@else
				<a onclick="$('#modal1').modal('open');" class="btn-large waves-effect waves-light teal lighten-1">
					Sign In
				</a>
				@endif
			</div>
			...
			<div class="col s12 center">
				...
				<p class="left-align light" id="cya">
					...
					<form class="" action="{{ Utility::rootUrl() }}" id="your_attn_form">
						...
						<div class="input-field col s12">
							<input type="button" value="Check" class="btn btn-success btn-block " disabled id="check-btn"
								...
								<tbody>
									...
									<tr>
										<td>
											<b>{{ $arr['name'] }} </b>
											<br> ( {{ $arr['code'] }} )</td>
										<td>{{ Utility::percentage($arr['attn'],$arr['total']) }} %</td>
										<td>{{ $arr['attn'] }}</td>
										<td>{{ $arr['total'] }}</td>
									</tr>
									@endforeach 
							...
							<table class="table table-striped table-bordered table-condensed table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{ Utility::percentage($sem->attendance,$sem->total) }} %</td>
		...
		<div class="row">
			<div class="col s12 m4">
				<div class="icon-block">
					...
					<p class="light">We did most of the heavy lifting for you to provide a default settings that incorporate our custom components. Additionally,
			...
			<div class="col s12 m4">
				<div class="icon-block">
					...
					<p class="light">By utilizing experized skill from our teacher and huge pool of example and test cases, we were able to create a framework
						that incorporates components and automation that provide more easy of use and centralized control. Additionally, a
			...
			<div class="col s12 m4">
				<div class="icon-block">
					...
					<p class="light">We have provided detailed documentation as well as live examples to help new users get started. We are also always open
